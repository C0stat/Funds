...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
  ...
  <div>
    <label className="text-sm">Novos Investidores Mensais N1</label>
    <Input
      type="number"
      className="appearance-none"
      style={{ MozAppearance: 'textfield' }}
      value={novosInvestidoresMensaisN1}
      onChange={(e) => setNovosInvestidoresMensaisN1(+e.target.value)}
    />
  </div>
  <div>
